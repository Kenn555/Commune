...
urlpatterns = [
    ...
    path("death/delete/<int:death_id>/", views.death_delete, name='death-delete'), 
    # Mariage
    path("marriage/", views.marriage, name='marriage'),
    path("marriage/register/", views.marriage_register, name='marriage-register'),
    path("marriage/save/", views.marriage_save, name='marriage-save'),
    path("marriage/delete/<int:marriage_id>/", views.marriage_delete, name='marriage-delete'), 
